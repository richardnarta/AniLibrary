...
class SeasonAnimePagingSource(private val season:String, private val year:String): PagingSource<Int, AnimeNode>() {
    ...
    override suspend fun load(params: LoadParams<Int>): LoadResult<Int, AnimeNode> {
        return try {
            ...
            val response = ApiConfig.getApiService().getSeasonAnime(year,season,currentOffset)
